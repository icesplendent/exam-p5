   ...
   public:
    ...
    void calibrate() {
        ...
        for (int i = 0; i < 200; ++i) {
            ...
            double accel_sample_x =
                (double)accDataXYZ[0] * (double)scale / 20640.0;
            double accel_sample_y =
                (double)accDataXYZ[1] * (double)scale / 20640.0;
            double accel_sample_z =
                (double)accDataXYZ[2] * (double)scale / 20640.0;
